...
namespace SimplyRugby.ViewPlayersAmateur
{
    /// <summary>
    /// Page to view players for amateur coaches
    /// </summary>
    public sealed partial class ViewPlayersAmateur : Page
    {
        public ObservableCollection<Player.Player> Players { get; } = new ObservableCollection<Player.Player>();
        public ViewPlayersAmateur()
        {
            this.InitializeComponent();
            this.Loaded += ViewPlayersAmateur_Loaded;
        }
        /// <summary>
        /// method to load the players for the current coach
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void ViewPlayersAmateur_Loaded(object sender, RoutedEventArgs e)
        {
