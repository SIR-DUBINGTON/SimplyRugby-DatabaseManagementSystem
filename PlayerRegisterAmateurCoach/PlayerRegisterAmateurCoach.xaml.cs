...
namespace SimplyRugby.PlayerRegisterAmateurCoach
{
    /// <summary>
    /// Page for registering a player under an amateur coach.
    /// </summary>
    public sealed partial class PlayerRegisterAmateurCoach : Page
    {
        public ObservableCollection<Team.Team> Teams { get; set; } = new ObservableCollection<Team.Team>();

        public PlayerRegisterAmateurCoach()
        {
            this.InitializeComponent();
            this.Loaded += Page_Loaded;
        }
        /// <summary>
        /// Method to load the method to load teams for the current coach.
        /// </summary>
