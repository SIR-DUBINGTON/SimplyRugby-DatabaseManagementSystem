...
namespace SimplyRugby.PlayerStatsPro
{
    /// <summary>
    /// Page for the player stats pro
    /// </summary>
    public sealed partial class PlayerStatsPro : Page
    {
        ...
        /// <summary>
        /// Method to add a new skill entry to the list
        /// </summary>
        ...
        /// <summary>
        /// Method to push skill entries to the database
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
