...
namespace SimplyRugby.ViewStatsAmateur
{
    /// <summary>
    /// Page for viewing stats of players for amateur coaches
    /// </summary>
    public sealed partial class ViewStatsAmateur : Page
    {
        ...
        public ViewStatsAmateur()
        {
            this.InitializeComponent();
        }
        /// <summary>
        /// Method to populate the players in the combobox
        /// </summary>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// UI update combo box depending on player selection 
        /// </summary>
