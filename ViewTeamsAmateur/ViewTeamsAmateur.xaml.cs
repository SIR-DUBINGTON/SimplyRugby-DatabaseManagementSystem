...
namespace SimplyRugby.ViewTeamsAmateur
{
    /// <summary>
    /// Page for viewing the teams that the currently logged-in staff member coaches.
    /// </summary>
    public sealed partial class ViewTeamsAmateur : Page
    {
        public ObservableCollection<Team.Team> Teams { get; set; } = new ObservableCollection<Team.Team>();

        public ViewTeamsAmateur()
        {
        ...
        /// <summary>
        /// Method to load the method to load the teams that are currently logged-in staff member coaches.
        /// </summary>
        ...
        /// <summary>
        /// Method to load the teams that are currently logged-in staff member coaches.
        /// </summary>
        /// <returns></returns>
