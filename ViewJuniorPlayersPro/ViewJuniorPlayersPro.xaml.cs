...
namespace SimplyRugby.ViewJuniorPlayersPro
{
    /// <summary>
    /// Page for viewing junior players for a professional coach
    /// </summary>
    public sealed partial class ViewJuniorPlayersPro : Page
    {
        public ObservableCollection<Player.Player> JuniorPlayers { get; } = new ObservableCollection<Player.Player>();

        public ViewJuniorPlayersPro()
        {
        ...
        /// <summary>
        /// Method to load the method to load junior players for the professional coach
        /// </summary>
        ...
        /// <summary>
        /// Method to load junior players for the professional coach
        /// </summary>
        /// <returns></returns>
