...
namespace SimplyRugby.MatchAndTraining.ViewAttendanceAmateur
{
    /// <summary>
    /// Page for viewing attendance of amateur players in a team.
    /// </summary>
    public sealed partial class ViewAttendanceAmateur : Page
    {
        ...
        public ViewAttendanceAmateur()
        {
            this.InitializeComponent();
            this.Loaded += Page_Loaded;
        }
        /// <summary>
        /// Mehod to call the method to load the teams of the logged in coach
        /// </summary>
        ...
        /// <summary>
        /// Method to load the attendance of the selected training session
        /// </summary>
        ...
        /// <summary>
        /// Method to search for the attendance of the selected training session
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
