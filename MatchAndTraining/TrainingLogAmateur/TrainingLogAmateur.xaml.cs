...
namespace SimplyRugby.MatchAndTraining.TrainingLogAmateur
{
    /// <summary>
    /// Page for logging training records for amateur teams.
    /// </summary>
    public sealed partial class TrainingLogAmateur : Page
    {
        public ObservableCollection<Team.Team> Teams { get; set; } = new ObservableCollection<Team.Team>();

        public TrainingLogAmateur()
        {
        ...
        /// <summary>
        /// Method to handle the submission of the training record form.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Method to show a success message to the user.
        /// </summary>
