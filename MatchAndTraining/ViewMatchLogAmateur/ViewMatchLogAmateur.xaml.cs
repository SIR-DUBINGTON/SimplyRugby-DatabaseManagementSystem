...
namespace SimplyRugby.MatchAndTrainingAmateur.ViewMatchLogAmateur
{
    /// <summary>
    /// Page for viewing match logs for amateur coaches.
    /// </summary>
    public sealed partial class ViewMatchLogAmateur : Page
    {
