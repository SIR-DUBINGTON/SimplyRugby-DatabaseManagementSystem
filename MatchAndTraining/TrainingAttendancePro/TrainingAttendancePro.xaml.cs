...
namespace SimplyRugby.MatchAndTraining.TrainingAttendancePro
{
    /// <summary>
    /// Page for professional coaches to record attendance of players in training sessions.
    /// </summary>
    public sealed partial class TrainingAttendancePro : Page
    {
        ...
        /// <summary>
        /// Method to call the load of the teams of the logged in coach
        /// </summary>
        ...
        /// <summary>
        /// Method to load the teams of the logged in coach
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Method to load the training sessions of the selected team
        /// </summary>
        ...
        /// <summary>
        /// Method to load the players of the selected team
        /// </summary>
        /// <param name="teamId"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Method to submit the attendance of the selected player
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Method to save the attendance of the selected player
        /// </summary>
