...
namespace SimplyRugby.MatchAndTraining.ViewTrainingLogAmateur
{
    /// <summary>
    /// Page for viewing training logs for amateur teams.
    /// </summary>
    public sealed partial class ViewTrainingLogAmateur : Page
    {
        ...
        public ViewTrainingLogAmateur()
        {
            this.InitializeComponent();
        }
        /// <summary>
        /// Method to load the methods for the teams for the logged-in coach and the training dates for the first team.
        /// </summary>
        ...
        /// <summary>
        /// Method to handle the selection change event for the date combo box.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Method to handle the selection change event for the team combo box.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Method to show a message in a dialog box.
        /// </summary>
