...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class MatchLogRegisterAmateur : Page
    {
        public MatchLogRegisterAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/MatchLog.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
