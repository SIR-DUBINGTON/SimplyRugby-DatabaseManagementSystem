...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class RegisteringPlayersAmateur : Page
    {
        public RegisteringPlayersAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/PlayerRegister.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
