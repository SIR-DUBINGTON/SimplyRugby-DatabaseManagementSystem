...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class FullScreenAmateur : Page
    {
        public FullScreenAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ToggleFullscreen.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
