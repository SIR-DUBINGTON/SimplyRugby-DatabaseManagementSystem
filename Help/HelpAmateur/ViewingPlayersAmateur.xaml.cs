...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class ViewingPlayersAmateur : Page
    {
        public ViewingPlayersAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewPlayers.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
