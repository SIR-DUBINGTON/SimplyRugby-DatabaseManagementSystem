...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class NavHelpAmateur : Page
    {
        public NavHelpAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/NavCoach.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
