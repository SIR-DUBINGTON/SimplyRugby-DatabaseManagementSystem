...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class JuniorPlayersRegisterAmateur : Page
    {
        public JuniorPlayersRegisterAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/JuniorPlayerRegister.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
