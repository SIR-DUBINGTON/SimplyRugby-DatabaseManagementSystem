...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class ViewingTeamsAmateur : Page
    {
        public ViewingTeamsAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewTeamsCoach.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
