...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class TrainingLogRegisterAmateur : Page
    {
        public TrainingLogRegisterAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/TrainingLog.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
