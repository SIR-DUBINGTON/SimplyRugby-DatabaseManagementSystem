...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class RegisterPlayerStatsAmateur : Page
    {
        public RegisterPlayerStatsAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/RegisterStats.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
