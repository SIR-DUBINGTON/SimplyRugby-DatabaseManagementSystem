...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class AttendanceLogViewAmateur : Page
    {
        public AttendanceLogViewAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewAttendance.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
