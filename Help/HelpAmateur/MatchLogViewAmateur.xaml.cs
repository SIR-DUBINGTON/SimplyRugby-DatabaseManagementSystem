...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class MatchLogViewAmateur : Page
    {
        public MatchLogViewAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewMatchLog.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
