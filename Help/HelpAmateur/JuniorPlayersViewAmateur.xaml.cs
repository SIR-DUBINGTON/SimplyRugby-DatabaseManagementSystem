...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class JuniorPlayersViewAmateur : Page
    {
        public JuniorPlayersViewAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewJuniorPlayers.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
