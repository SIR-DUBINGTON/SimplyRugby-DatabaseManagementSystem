...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class LogoutAmateur : Page
    {
        public LogoutAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/Logout.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
