...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class ViewingPlayerStatsAmateur : Page
    {
        public ViewingPlayerStatsAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewStats.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
