...
namespace SimplyRugby.Help.HelpAmateur
{
    ...
    /// </summary>
    public sealed partial class AttendanceLogRegisterAmateur : Page
    {
        public AttendanceLogRegisterAmateur()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/LogAttendance.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
