...
namespace SimplyRugby.Help.HelpAdmin
{
    ...
    /// </summary>
    public sealed partial class ViewingTeamsAdmin : Page
    {
        public ViewingTeamsAdmin()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewTeamsAdmin.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
