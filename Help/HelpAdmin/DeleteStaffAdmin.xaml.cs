...
namespace SimplyRugby.Help.HelpAdmin
{
    ...
    /// </summary>
    public sealed partial class DeleteStaffAdmin : Page
    {
        public DeleteStaffAdmin()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/StaffDeletion.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
