...
namespace SimplyRugby.Help.HelpAdmin
{
    ...
    /// </summary>
    public sealed partial class CreatingTeamsAdmin : Page
    {
        public CreatingTeamsAdmin()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/CreateTeams.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
