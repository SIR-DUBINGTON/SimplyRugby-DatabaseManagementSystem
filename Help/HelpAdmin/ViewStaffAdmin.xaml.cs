...
namespace SimplyRugby.Help.HelpAdmin
{
    ...
    /// </summary>
    public sealed partial class ViewStaffAdmin : Page
    {
        public ViewStaffAdmin()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/ViewStaff.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
