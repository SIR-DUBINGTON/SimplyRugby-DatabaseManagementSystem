...
namespace SimplyRugby.Help.HelpMainPage
{
    ...
    /// </summary>
    public sealed partial class AdminCreateMain : Page
    {
        public AdminCreateMain()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/CreateAccountAdmin.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
