...
namespace SimplyRugby.Help.HelpMainPage
{
    ...
    /// </summary>
    public sealed partial class LoggingInMain : Page
    {
        public LoggingInMain()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/LoggingIn.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
