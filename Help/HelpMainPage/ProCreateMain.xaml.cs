...
namespace SimplyRugby.Help.HelpMainPage
{
    ...
    /// </summary>
    public sealed partial class ProCreateMain : Page
    {
        public ProCreateMain()
        {
            this.InitializeComponent();
            MyVideo.Source = new Uri("ms-appx:///Assets/CreateAccountPro.mkv"); // Replace "MyVideo.mp4" with the name of your video file
        }
